...
<html>
    ...
    <div class="fadeIn first">
        <h1 class="details bg-blue">Reset your password</h1>
    </div>

    <!-- Login Form -->
    <form action="login2" method="post" name="loginForm">
    
      <h2>EMP-NO:${param.empNo}</h2>
      <input type="text" id="password" class="fadeIn third" name="password" placeholder="password">
      <input type="text" id="password" class="fadeIn third" name="password2" placeholder="Confirm password">
