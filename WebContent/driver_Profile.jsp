...
<div class="container main-wrapper pt-30" style="max-width:80%; max-height:70%;">
        <div class="contert-wrapper pb-15">
            ...
            <form action="driverUpdate" method="post" name="addemp">
                  <div class="row">
                       <div class="col-md-12">
                       ...
                       <% 
                        HttpSession session1 = request.getSession();  					
     					String eId = (String) session1.getAttribute("eid");
                       	...
                       	ResultSet rs=driverObj.driverAll(eId);
						while(rs.next()){
                       ...
                       %>
                                   ...
                                   <div class="row form-row">    
                                        ...
                                        <div class="col-md-4 input-layout">
                                            ...
                                            <input type="text" class="lettersonly" name="fn" value="<%=rs.getString(2)%>">
                                        </div>
                                        
                                        <div class="col-md-4 input-layout">
                                            <h4 class="title">LAST-NAME</h4>
                                            <input type="text" class="lettersonly" name="ln" value="<%=rs.getString(3)%>">
                                        </div>    
                                    </div> 
                                    ...
                                    <div class="row form-row">    
                                        ...
                                        <div class="col-md-4 input-layout">
                                            ...
                                            <input type="text" class="lettersonly" name="tn" value="<%=rs.getString(4)%>">
                                        </div>
                                        <div class="col-md-4 input-layout">
                                            <h4 class="title">CITY</h4>
                                            <input type="text" class="lettersonly" name="ci" value="<%=rs.getString(5)%>">
                                        </div>
