    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <div class="navbar-header navbar-left pr-30">
                <h2 class="navbar white pt-20" style="font-family:Times New Roman">EMPLOYEE TRANSPORT ADMINISTRATION</h2>
            </div>
           <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right pt-15">
                    <li><a href="admin_User.jsp">USER ACCOUNTS</a></li>
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle">MANAGE<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="admin_Vehicle.jsp">VEHICLES</a></li>
                            <li class="divider"></li>
                            <li><a href="admin_Routes.jsp">ROUTES</a></li>
                            <li class="divider"></li>
                            <li><a href="admin_Admin.jsp">ADMINS</a></li>                        
                        </ul>
                     </li>                                         
                     <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="Basics/UserProfile.php"> MY PROFILE</a></li>
                            <li><a href="MainDashboard/Settings.php">SETTINGS</a></li>
                            <li class="divider"></li>
