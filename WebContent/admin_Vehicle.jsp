...
<div class="container main-wrapper pt-30" style="max-width:80%; max-height:70%;">
        <div class="contert-wrapper pb-15">
            <div class="cell pb-20">
                <h1 class="title" style="font-size:30px">VEHICLE MANAGEMENT</h1>
            </div>
            <form action="adminVehicleAdd" method="post" id="adminDriverAdd">
                  <div class="row">
                       <div class="col-md-12">
                           
                                   <div class="row form-row">    
                                        <div class="col-md-4 input-layout">
                                            <h4 class="title">Vehicle-RegistaionNO</h4>
                                            <input type="text" class="lettersonly" name="vehiNo">
                                        </div>
                                        
                                        <div class="col-md-4 input-layout">
                                            <h4 class="title">Type</h4>
                                            <input type="text" class="lettersonly" name="type">
                                        </div>
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-md-4 input-layout">
                                            <h4 class="title">No of sheets</h4>
                                            <input type="text" class="lettersonly" name="nos">
                                        </div>
                                        
                                        <div class="col-md-4 input-layout">
                                            <h4 class="title">Engine Capacity</h4>
                                            <input type="text" class="lettersonly" name="ec">
                                        </div>
         	...
         	<div class="alert-warning" id="error">${param.message}</div><br><br>
                 ...
                 <h5 class="title">ADDED VEHICLE DETAILS</h5> 
                  <br>		
         		<div class="mCustomScrollbar" data-mcs-theme="dark">

  					<%
  						Admin admin=new Admin();
  						ResultSet rs=admin.getVehicles();
						while(rs.next()){
					%>	
					<h4 class="title" style="padding-top: 8px;;"><%=rs.getString(1)%>&nbsp &nbsp &nbsp<%=rs.getString(2)%>&nbsp &nbsp &nbsp<%=rs.getString(3)%>&nbsp &nbsp &nbsp<%=rs.getString(4)%>&nbsp &nbsp &nbsp<a href="deleteVehicle.jsp?id=<%=rs.getString(1)%>"><span class="glyphicon glyphicon-trash" ></span>delete</a></h4>											
...
<script type="text/javascript">
    ...
    $('body').delegate('.lcs_switch', 'lcs-off', function() {       
     ...
     function deleteVehi(id)
     {
        ...
        jQuery.ajax({
        type: "POST",
        url: 'src/admin/adminVehicleDelete.java',
        dataType: 'json',
        data: id,
