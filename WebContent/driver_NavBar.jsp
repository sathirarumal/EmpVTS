    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <div class="navbar-header navbar-left pr-30">
                <h2 class="navbar white pt-20" style="font-family:Times New Roman">EMPLOYEE TRANSPORT DRIVER-PROFILE</h2>
            </div>
           <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right pt-15">
                    <li><a href="driver_EmpList.jsp">EMPLOYEE LIST</a></li>
                    <li><a href="driver_Vehicle.jsp" >VEHICLE DETAILS</a></li>
                    <li><a href="driver_Route.jsp">ROUTE DETAILS</a></li>                                         
                     <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="driver_Profile.jsp"> MY PROFILE</a></li>
                            <li class="divider"></li>
